...
INSERT INTO "QLHSUT"."QLHSUT_HOP_DONG_DANG_TUYEN" (MAHOPDONG, MADT, NGAYKI, DIEUKHOAN_HD, NGAYHETHAN, TT_UUDAI) VALUES ('50004', '30005', TO_DATE('2024-02-28', 'YYYY-MM-DD'), N'Hủy hợp đồng nếu công ty không làm theo đúng yêu cầu', TO_DATE('2024-07-15', 'YYYY-MM-DD'), '40001');
...
ADD CONSTRAINT FK_DN_NDD FOREIGN KEY(NDD) REFERENCES QLHSUT.QLHSUT_NGUOI_DAI_DIEN(MANDD) ON DELETE CASCADE;
